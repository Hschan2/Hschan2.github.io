        ...
        <footer className="footer">
            <div className="footer_container container">
                ...
                <div className="footer_social">
                    ...
                    <a href="https://www.instagram.com/h_s.__.b/" className="footer_social-link" target="_blank">
                        <i className="bx bxl-instagram"></i>
                    </a>
                    <a href="https://hseongchan2.tistory.com/" className="footer_social-link" target="_blank">
                        <i className="bx bxl-blogger"></i>
                    </a>
                    <a href="https://blog.naver.com/seongchan_" className="footer_social-link" target="_blank">
